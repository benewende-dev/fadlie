...
| `candidats` | 2 211 pairs → 97 | of those 97, the judge threw out 13 |
...
Operations* while its three twins sit in *Data Platform Team*. Fadlie reports it
and does not choose. Someone decided, or someone erred, and neither is an
agent's call. The conflict is in
[`examples/governance_gaps_all.json`](examples/governance_gaps_all.json), with
the four datasets and their two answers.
